...
"./vendor/4geo35/staff-pages/src/resources/views/livewire/web/**/*.blade.php",
"./vendor/4geo35/staff-pages/config/staff-pages.php",` в `tailwind.config.js`, созданный в пакете `tailwindcss-theme`.
