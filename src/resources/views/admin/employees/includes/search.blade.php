<div class="flex justify-between mb-indent-half">
    <div class="flex flex-col space-y-indent-half md:flex-row md:space-x-indent-half md:space-y-0">
        <input type="text" aria-label="ФИО" placeholder="ФИО" class="form-control" wire:model.live="searchName">
    ...
    <div class="flex items-center space-x-2">
        @can("create", config("staff-pages.customEmployeeModel") ?? \GIS\StaffPages\Models\Employee::class)
        ...
        @endcan
        @can("order", config("staff-pages.customEmployeeModel") ?? \GIS\StaffPages\Models\Employee::class)
